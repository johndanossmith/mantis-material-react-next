      ...
      <Page size="A4" style={styles.page}>
        <View style={styles.container}>
          <View style={styles.row}>
            <Image alt="user" style={styles.image} src={`/assets/images/users/avatar-${!customer.avatar ? 1 : customer.avatar}.png`} />
          ...
          <View style={styles.IconContainer}>
            <View style={[styles.row, styles.IconRow]}>
              <Image alt="mail" src={Mail} style={styles.icon} />
              <Text style={styles.iconTitle}>{customer.email}</Text>
            </View>
            <View style={[styles.row, styles.IconRow]}>
              <Image alt="map" src={Maps} style={styles.icon} />
              <Text style={styles.iconTitle}>{customer.country}</Text>
            </View>
          </View>
          <View style={styles.IconContainer}>
            <View style={[styles.row, styles.IconRow]}>
              <Image alt="phone" src={Phone} style={styles.icon} />
              <Text style={styles.iconTitle}>{customer.contact}</Text>
            </View>
            <View style={[styles.row, styles.IconRow]}>
              <Image alt="linkedin" src={LinkIcon} style={styles.icon} />
              <Link
