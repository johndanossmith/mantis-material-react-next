        ...
        <Grid item xs={12}>
          ...
          >
            <Formik
              ...
              onSubmit={(values) => {
                console.log('multiple file upload submit - ', values);
                // submit form
              }}
        ...
        <Grid item xs={12}>
          <MainCard title="Upload Single File">
            <Formik
              initialValues={{ files: null }}
              onSubmit={(values) => {
                console.log('single file upload submit - ', values);
                // submit form
              }}
              validationSchema={yup.object().shape({
                files: yup.mixed().required('Avatar is a required.')
        ...
        <Grid item xs={12}>
          <MainCard title="Upload Avatar">
            <Formik
              initialValues={{ files: null }}
              onSubmit={(values) => {
                console.log('avatar upload submit - ', values);
                // submit form
              }}
              validationSchema={yup.object().shape({
                files: yup.mixed().required('Avatar is a required.')
...
DropzonePage.getLayout = function getLayout(page) {
